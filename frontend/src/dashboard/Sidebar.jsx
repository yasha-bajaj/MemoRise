...
function Sidebar({ setComponent }) {
  ...
  return (
    <>
      ...
      <div
        className={`w-64 h-full shadow-lg fixed top-0 left-0 bg-slate-700 transition-transform duration-300 transform sm:translate-x-0 ${
      ...
      >
        ...
        <div className="text-center">
          <img
            ...
            alt="User"
          />
          <p className="text-lg text-white font-semibold">{profile?.user?.name}</p>
        </div>
