    ...
    <>
      <footer className=" py-10 bg-black ">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className=" text-center md:text-start">
            <h2 className="text-lg text-green-600 font-semibold mb-4">Products</h2>
          ...
          <div className=" text-center md:text-start">
            <h2 className="text-lg text-green-600 font-semibold mb-4">Design to code</h2>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                  Figma plugin
          ...
          <div className=" text-center md:text-start">
            <h2 className="text-lg text-green-600 font-semibold mb-4">Comparison</h2>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                  DhiWise vs Anima
          ...
          <div className=" text-center md:text-start">
            <h2 className="text-lg text-green-600 font-semibold mb-4">Company</h2>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-400 hover:text-white">
                  About Us
      ...
      <div className=" container mx-auto  flex flex-col md:flex-row justify-between items-center bg-slate-900">
        <div className="text-xl font-semibold hidden md:flex text-white ">
          GitHub<span className="text-green-500 font-bold">Blogs</span>
        </div>
